...
export class FormTemplateService {
    ...
    async createFormTemplate(data: Prisma.FormTemplateCreateInput): Promise<FormTemplate> {
    ...
    async updateFormTemplate(id: number, data: Prisma.FormTemplateUpdateInput): Promise<FormTemplate> {
