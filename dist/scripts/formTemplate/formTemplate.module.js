...
const formTemplate_controller_1 = require("./formTemplate.controller");
...
exports.FormTemplateModule = FormTemplateModule = __decorate(
  [
    (0, common_1.Module)({
      controllers: [formTemplate_controller_1.FormTemplateController],
      providers: [formTemplate_service_1.FormTemplateService],
    }),
  ],
  FormTemplateModule,
);
//# sourceMappingURL=formTemplate.module.js.map
